...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2019 at 01:56 AM
...
CREATE TABLE `tb_buku` (
  ...
  `link/path` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tb_login_user` (
  ...
  `nama _user` varchar(20) NOT NULL,
...
INSERT INTO `tb_login_user` (`id_user`, `nama _user`, `username`, `password`, `id_akses`) VALUES
(1, 'imel', 'imel', '123', 1);
...
--
ALTER TABLE `tb_login_user`
  ADD CONSTRAINT `tb_login_user_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tb_peminjaman` (`id_user`),
...
ALTER TABLE `tb_peminjaman`
  ...
  ADD CONSTRAINT `tb_peminjaman_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `tb_login_user` (`id_user`),
