...
<!-- 						<a href="hasil_pencarian.php"><i class="zmdi zmdi-search"></i></a> -->
	        					...
	        					<div class="row">
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="ipa.php"><img src="images/books/4.png" alt="product image" style="height: 200px; height: 400px;"></a>
											<div class="hot__box">
												<span class="hot-label">BEST SALLER</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.html">Victoria</a></h4>
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="ipa.php"><img src="images/books/5.png" alt="product image" style="height: 200px; height: 400px;"></a>
											<div class="hot__box color--2">
												<span class="hot-label">HOT</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.html">Si Anak Kuat</a></h4>
											<ul class="prize d-flex">
											</ul>
											<div class="action">
												<div class="actions_inner">
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<div class="product__content content--center">
											<h4><a href="single-product.html">Si Anak Cahaya</a></h4>
											<ul class="prize d-flex">
											</ul>
											<div class="action">
												<div class="actions_inner">
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="ipa.php"><img src="images/books/7.png" alt="product image" style="height: 200px; height: 400px;"></a>
											<div class="hot__box">
												<span class="hot-label">HOT</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.html">Majnun</a></h4>
											<ul class="prize d-flex">
											</ul>
											<div class="action">
												<div class="actions_inner">
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="single-product.html"><img src="images/books/16.jpg" alt="product image"  style="height: 200px; height: 400px;"></a>
											<div class="hot__box">
												<span class="hot-label">BEST SALER</span>
											</div>
										</div>
										<div class="product__content content--center content--center">
											<h4><a href="single-product.html">Cinta Dalam Diam</a></h4>
											<ul class="prize d-flex">
											</ul>
											<div class="action">
												<div class="actions_inner">
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="single-product.html"><img src="images/books/17.jpg" alt="product image"  style="height: 200px; height: 400px;"></a>
											<div class="hot__box">
												<span class="hot-label">BEST SALER</span>
											</div>
										</div>
										<div class="product__content content--center content--center">
											<h4><a href="single-product.html">The Glovemaker</a></h4>
											<ul class="prize d-flex">
											</ul>
											<div class="action">
												<div class="actions_inner">
        ...
        <!-- End Shop Page -->
		<!-- Footer Area -->
		<footer id="wn__footer" class="footer__area bg__cat--80 brown--color">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="footer__widget footer__menu">
								<div class="ft__logo">
									<a href="index.html">
										<img src="images/logo/3.png" alt="logo" style="height: 100px; width: 100px; border-radius: 50%;">
									</a>
